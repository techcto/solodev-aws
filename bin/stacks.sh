...
if [ $LEGACY == 1 ]; then
    ...
    --parameters file:///${CODEBUILD_SRC_DIR}/bin/solodev-pro-classic.json
    ...
    --parameters file:///${CODEBUILD_SRC_DIR}/bin/solodev-enterprise-classic.json
...
if [ $LITE == 1 ]; then
    ...
    --parameters file:///${CODEBUILD_SRC_DIR}/bin/solodev-lite-single.json
...
if [ $PRO == 1 ]; then
    ...
    --parameters file:///${CODEBUILD_SRC_DIR}/bin/solodev-pro-single.json
    ...
    --parameters file:///${CODEBUILD_SRC_DIR}/bin/solodev-pro-single-byol.json
...
if [ $ENTERPRISE == 1 ]; then
    ...
    --parameters file:///${CODEBUILD_SRC_DIR}/bin/solodev-enterprise-opsworks.json
...
if [ $DOCKER == 1 ]; then
    ...
    --parameters file:///${CODEBUILD_SRC_DIR}/bin/solodev-enterprise-ecs.json
...
if [ $MARKETPLACE == 1 ]; then
    ...
    --parameters file:///${CODEBUILD_SRC_DIR}/bin/solodev-enterprise-ecs-dev.json
